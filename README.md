# nucleo_trimmer
'''
This is a nucleotide sequence trimmer when given a FASTQ file. The program was created following the prompt below. Please note the file used to run the code within the main function is specific to my program.
